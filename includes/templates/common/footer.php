                    ...
                    <div class="container">
                        ...
                        <div class="row py-3 py-md-0 pb-lg-4 d-flex align-items-end">
                            ...
                            <div class="footer-links col-12 col-md-10 d-flex flex-wrap flex-xl-nowrap align-items-end w-100 pe-0">
                                ...
                                <!--<a href="#landing" title="Back to top" class="btn back-btn scroll-to">Back to top</a>-->

                                <div class="footer-tagline py-3 py-md-4 pt-lg-5  pb-lg-2  pt-xxl-0 ps-0 ps-xxl-5 w-100">
                                    <picture>
                                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="215" height="auto" viewBox="0 0 291 104" style="enable-background:new 0 0 291 104;" xml:space="preserve">
                                        <g>
										<path class="st0-tag" d="M183.5,61.1L183.5,61.1c-0.3-0.3-0.8-0.2-1.1,0c-3.3,3.9-7.2,5.9-11.6,5.9c-5.4,0.1-11.8-2.6-18.7-8.1
		...
		<script>
		  ...
		  const isVideo = urlParams.get('video');
		  if (isVideo === 'true') {
			  const videoElement = document.getElementById('video');
			  if (videoElement) {
				  lity(videoElement);
				  jQuery('#core-video').bind("ended", function() {
					  setTimeout(function() {
						  jQuery('.video-loader, .lity').fadeOut();
